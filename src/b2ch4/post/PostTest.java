...
/**
 * В этой программе демострируется применение класса
...
public class PostTest {
    ...
    public static void main(String[] args) throws IOException {
        String propsFilename = args.length > 0 ? args[0] : "/home/olebas13/IdeaProjects/javacore1/src/b2ch4/post/post.properties";
        ...
        Object userAgent = props.remove("User_Agent");
     ...
     * @param userAgent Пользовательский посредник или пустое значение null,
     *                  если используется посредник по умолчанию
     * @param redirects Количество последующих переадресаций вручную или
     *                  значение -1, если переадресация автоматическая
     * @return Данные, возращаемые с сервера
     * @throws IOException
     */
