...
public class DownstreamCollectors {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Stream<City> cities = readCities("src/b2ch1/collecting/cities.txt");
        ...
        cities = readCities("src/b2ch1/collecting/cities.txt");
        ...
        System.out.println(stateToCityPopulationSummary.get("LA"));
